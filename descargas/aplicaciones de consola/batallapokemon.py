...
class Pokemon:
    ...
    def __str__(self):
        return f"Pokemon: {self.nombre}, Ataque Maximo: {self.ataque_maximo}, Vida Maxima: {self.vida_maxima}, Vida Actual: {self.vida_actual}"
...
def crearEntrenadorPokemon(numero_entrenador):
    ...
    nombre_pokemon = input(
        f"Ingrese el nombre del pokemon del entrenador {numero_entrenador}: "
    )
...
def main():
    ...
    while True:
        ...
        print(f"\nEstadisticas de {pokemon1.nombre}: ")
        print(pokemon1)
        print(f"\nEstadisticas de {pokemon2.nombre}: ")
        print(pokemon2)
        ...
        while True:
            ...
            if opcion == "P":
                ...
                print(
                    f"\n{pokemon1.nombre} ataca a {pokemon2.nombre} y le causa {ataque_pokemon1} de danio."
                )
                print(f"Vida Actual de {pokemon2.nombre}: {pokemon2.vida_actual}")
                print(
                    f"\n{pokemon2.nombre} ataca a {pokemon1.nombre} y le causa {ataque_pokemon2} de danio."
                )
                ...
                print("\nJuego terminado.")
                print(f"Estadisticas de {entrenador1} y su Pokemon:")
                print(f"Victorias: {victorias}, Derrotas: {derrotas}")
                return
            else:
                print(
                    "Opcion no valida. Por favor, ingrese 'P' para pelear o 'F' para finalizar el juego."
                )
